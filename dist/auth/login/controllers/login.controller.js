...
const login = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const valid = yield (_a = findUser.comparePassword) === null || _a === void 0
        ? void 0
        : _a.call(findUser, password);
      if (!valid) return res.status(401).json({ success: false, error: { message: "password invalid" } });
      const { accessToken, refreshToken } = yield (0, generateToken_util_1.generateToken)(
