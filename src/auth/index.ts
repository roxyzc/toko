...
import { checkExpiredToken, verifyToken } from '../middlewares/verifyToken.middleware';
...
route.post('/verifyAccount', validateSchema(schema.Auth.verifyOtp), verifyAccount);
